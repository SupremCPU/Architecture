...
import instructions.CPUOutputSignalBuffer;
...
//		}
	...
	private void executeNextInstruction() throws IllegalInstructionCodeException, InstructionExecuteException {
		try {
			/*
	 ...
	 */
	private void executeOneCircle(InstructionCircle circle) throws IllegalMemoryAddressException, RegisterNotFoundException, IllegalInstructionCodeException{
