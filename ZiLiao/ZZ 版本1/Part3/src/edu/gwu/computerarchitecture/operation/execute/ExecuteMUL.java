...
/**
 * 
 * implement the execution of MUL instruction
 *
 * <p>detailed comment
 ...
 * @version 1.0
 */
public class ExecuteMUL extends Execute
{
    public ExecuteMUL(CPUUnits units, Instruction instr)
    {
        super(units, instr);
    ...
    public void execute(){        
        ...
        alu.mul();
        instruction.dataToRegisterLow = alu.getResult1_WordType().getWord();
        instruction.dataToRegister = alu.getResult2_WordType().getWord();
    }
}