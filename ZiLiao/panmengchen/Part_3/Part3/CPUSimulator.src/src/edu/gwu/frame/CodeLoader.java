...
public class CodeLoader extends JPanel implements Observer{
	 ...
	 * Tab: user program
	 */
	private JRadioButton userSourceEditor,userSourceP1,userSourceP2;
	...
	public CodeLoader(){
		...
		userButtonsPanel.setLayout(new FlowLayout(FlowLayout.LEFT));
		userButtonsPanel.setPreferredSize(new Dimension(130,100));
