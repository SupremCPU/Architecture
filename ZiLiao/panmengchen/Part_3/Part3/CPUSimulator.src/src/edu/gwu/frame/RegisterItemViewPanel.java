...
public class RegisterItemViewPanel extends JPanel{
	...
	public RegisterItemViewPanel(){
		...
		labelText.setPreferredSize(new Dimension(60,30));
		intText = new JTextField(3);
		binaryText = new JTextField(10);
		modifyButton = new JButton("Modify");
		//modifyButton.setPreferredSize(new Dimension(30,30));
		...
		items = new JPanel();
		items.setLayout(new GridLayout(7,4,3,1));
